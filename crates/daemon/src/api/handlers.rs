...
use crate::qemu::{QemuConfig, QemuStatus, QemuSupervisor, ShellCommandRequest};
...
impl ErrorResponse {
    ...
    pub fn with_type(status: StatusCode, detail: String, r#type: Option<String>) -> Self {
        Self {
            r#type,
...
pub async fn exec_and_parse<T: for<'de> Deserialize<'de>>(
    ...
    match supervisor.execute_command(request).await {
            ...
            if !response.success {
                return Err((
                    ...
                    Json(ErrorResponse {
                        ...
                        r#type: Some("/errors/command-failed".to_string()),
                        instance: None,
                        request_id: None,
            ...
            serde_json::from_str(&json_str).map_err(|e| {
                (
                    ...
                    Json(ErrorResponse {
                        ...
                        r#type: Some("/errors/parse-failed".to_string()),
                        instance: None,
                        request_id: None,
        ...
        Err(e) => Err((
            ...
            Json(ErrorResponse {
                ...
                detail: e.to_string(),
                r#type: Some("/errors/shell-not-ready".to_string()),
                instance: None,
                request_id: None,
                error: "Shell not available".to_string(),
            }),
        )
            .into_response()),
    }
